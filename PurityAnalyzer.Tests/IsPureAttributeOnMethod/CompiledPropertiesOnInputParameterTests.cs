...
{
    [IsPure]
    public static int DoSomething(ImmutableDto1WithIsPureAttributeOnProperty input)
    {
        return input.Prop1;
    }
}";
...
{
    [IsPure]
    public static int DoSomething(ImmutableDto1WithIsPureAttributeOnClass input)
    {
        return input.Prop1;
    }
}";
