...
{
    [TestFixture]
    public class CastingFromPureExceptReadLocallyToPureAndVariableIsUsedOnlyByPureOrPureExceptReadLocallyMethodsTests
    {
        [Test]
        public void CastFromParameterAndDontUseResult_KeepsMethodPure()
        {
            string code = @"
using System;
...
public static class Module1
{
    ...
    public static int DoSomething(Derived source)
    {
        ...
        [Test]
        public void CastFromParameterAndPassResultToPureMethod_KeepsMethodPure()
        {
            string code = @"
using System;
...
public static class Module1
{
    ...
    public static void PureMethod(Base x)
    {
        ...
        [Test]
        public void CastFromParameterAndPassResultToPureMethodDirectly_KeepsMethodPure()
        {
            string code = @"
using System;
...
public static class Module1
{
    ...
    public static void PureMethod(Base x)
    {
        ...
        [Test]
        public void CastFromParameterAndPassResultToPureExceptReadLocallyMethod_KeepsMethodPure()
        {
            string code = @"
using System;
